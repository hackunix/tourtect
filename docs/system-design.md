...
| SE-07 | Scam score dựa trên hành vi/bằng chứng, không dựa riêng vào loại quán, nghề nghiệp, hoàn cảnh kinh tế hoặc diện mạo con người |
| SE-08 | Pattern ép mua, unsolicited goods/service, false fee và staged dispute có câu hỏi phân biệt cùng safe action riêng |
